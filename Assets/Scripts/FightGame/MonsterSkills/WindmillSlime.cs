...
public class WindmillSlime : MonoBehaviour
{
    ...
    [SerializeField] private GameObject windmillSlimeObject;
    ...
    public void InitializedSkillInfo()
    {
        ...
        windmillSlimeObject = Resources.Load<GameObject>("Prefabs/MonsterSkills/WindmillSlime");
    }
